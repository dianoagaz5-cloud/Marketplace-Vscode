              ...
              <article key={product.id} className="card-surface overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4 flex items-center justify-between text-base font-semibold text-slate-900">
                    ...
                    <Link href={`/boutique`} className="text-brand-600 hover:text-brand-700">Détails</Link>
                  </div>
                </div>
              </article>
            ))}
              ...
              {featuredServices.map((service) => (
                <div key={service.id} className="card-surface p-6">
                  ...
                  <div className="mt-5 flex items-center justify-between text-sm font-semibold text-slate-900">
                    ...
                    <Link href="/services" className="text-brand-600 hover:text-brand-700">Commander</Link>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="space-y-8">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {featuredEbooks.map((ebook) => (
              <article key={ebook.id} className="card-surface grid gap-4 p-6 sm:grid-cols-[120px_1fr] sm:items-center">
                ...
                <div>
                  ...
                  <div className="mt-5 flex items-center justify-between text-sm font-semibold text-slate-900">
                    ...
                    <Link href="/ebooks" className="text-brand-600 hover:text-brand-700">Acheter</Link>
                  </div>
                </div>
              </article>
            ))}
        ...
        <section className="space-y-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {categories.map((category) => (
              <div key={category.name} className="card-surface p-6">
            ...
            {popularVendors.map((vendor) => (
              <article key={vendor.id} className="card-surface overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <Link href="/vendeurs" className="mt-5 inline-flex text-sm font-semibold text-brand-600 hover:text-brand-700">
                    Visiter la vitrine
                  </Link>
                </div>
              </article>
